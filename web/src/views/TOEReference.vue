    ...
    <div class="card toe-reference-body">
      <form class="toe-reference-form">
        <div class="form-group">
          ...
          <RichTextEditor v-model="form.toeName" placeholder="Enter TOE Name" min-height="160px" />
        </div>

        <div class="form-group">
          <label for="toeVersion">TOE Version:</label>
          <RichTextEditor v-model="form.toeVersion" placeholder="Enter TOE Version" min-height="160px" />
        </div>

        <div class="form-group">
          <label for="toeIdentification">TOE Identification:</label>
          <RichTextEditor v-model="form.toeIdentification" placeholder="Enter TOE Identification" min-height="160px" />
        </div>

        <div class="form-group">
          <label for="toeType">TOE Type:</label>
          <RichTextEditor v-model="form.toeType" placeholder="Enter TOE Type" min-height="160px" />
        </div>
      </form>
    </div>
  </div>
