    ...
    <div class="card toe-overview-body">
      <form class="toe-overview-form">
        <div class="form-section">
          ...
          <RichTextEditor v-model="form.toeOverview" placeholder="Enter TOE Overview (~100 words)" min-height="200px" />
        </div>

        <div class="form-section">
          <h3>TOE Type</h3>
          <p class="section-description">
            Please describe your TOE Type (What kind of device, its function, and its features), Short description (~200 Words)
          </p>
          <RichTextEditor
        ...
        <div class="form-section">
          ...
          <RichTextEditor v-model="form.toeUsage" placeholder="Enter TOE Usage description" min-height="260px" />
        </div>
