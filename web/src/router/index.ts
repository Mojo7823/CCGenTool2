...
import Assumptions from '../views/spd/Assumptions.vue'
import Threats from '../views/spd/Threats.vue'
import OrganizationalSecurityPolicies from '../views/spd/OrganizationalSecurityPolicies.vue'
